...
import tschipp.tschipplib.item.TSShovel;

public class ItemBoundShovel extends TSShovel {

	public ItemBoundShovel(ToolMaterial material) {
		super("bound_shovel", material, FIM.MODID);
		this.setCreativeTab(FIM.forgottenItems);
		FIHelper.setOutputCore(23, this, Items.DIAMOND_SHOVEL);
	...
	public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand)
	{
		...
		{
			FIHelper.printCraftingRecipe(world, player, 23);
